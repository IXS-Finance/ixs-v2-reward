...
contract SimpleBribeVotingRewardFlow is ExtendedBaseTest {
    ...
    function testMultiEpochBribeVotingRewardFlow() public {
        ...
        uint b1 = escrow.balanceOfNFT(1);
        console.log("b1", b1);
        uint b2 = escrow.balanceOfNFT(2);
        console.log("b2", b2);
        ...
        post = LR.balanceOf(address(owner));
        usdcPost = USDC.balanceOf(address(owner));
        console.log("new value", (post - pre) * 1000000 / currentBribe);
        ...
        assertApproxEqRel(post - pre, (currentBribe * 509632) / 1000000, PRECISION);
        assertApproxEqRel(usdcPost - usdcPre, (usdcBribe * 509632) / 1000000, PRECISION);
